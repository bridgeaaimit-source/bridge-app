  ...
  return (
    <AppShell>
      ...
      >
        ...
        {/* Stat Cards */}
        <m.div variants={item} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        {!loading && data?.companySignals?.length > 0 && (
          <m.div variants={item} className="mt-6 bg-white rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(13,148,136,0.06)] overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
        ...
        {/* Footer note */}
        <m.p variants={item} className="text-center text-xs text-gray-400 mt-8 pb-4">
