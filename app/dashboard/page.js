...
const PerformanceChart = dynamic(() => import('@/components/dashboard/PerformanceChart'), {
  ssr: false,
  loading: () => <div className="w-full h-full bg-slate-100 dark:bg-slate-800/50 rounded-2xl animate-pulse" />
});
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/70 backdrop-blur-md border border-white/30 rounded-3xl p-6 shadow-sm">
              ...
              <div className="w-full h-64 mt-4 relative">
                {isMounted && (
                  <PerformanceChart lineChartData={lineChartData} isOutOf1000={isOutOf1000} timeframe={timeframe} />
                )}
              </div>
            </div>
