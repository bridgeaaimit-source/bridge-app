...
export const MODEL_PRICING = {
  ...
  // Claude Sonnet 3.5 (legacy — used in gd-analysis, gd-score, generate-questions)
  ...
  // Claude Sonnet 4 (2025-05-14 release)
  // Anthropic public: $3.00 input / $15.00 output per 1M tokens
  'claude-sonnet-4-20250514': {
    vendor: 'Anthropic',
    family: 'Claude Sonnet 4',
    inputPer1M: 3.00 * USD_TO_INR,
    outputPer1M: 15.00 * USD_TO_INR,
  },

  // Claude Sonnet 4-5 (interim release used in parse-resume)
  // Anthropic public: $3.00 input / $15.00 output per 1M tokens
  'claude-sonnet-4-5': {
    vendor: 'Anthropic',
...
export const FEATURE_DEFAULT_MODEL = {
  ...
  'career-intelligence': 'claude-sonnet-4-20250514',    // /api/career-intelligence
  'aptitude':            'claude-sonnet-4-20250514',
  'recruiter':           'claude-sonnet-4-20250514',
  'pdf-chat':            'claude-sonnet-4-20250514',
  'resume':              'claude-sonnet-4-5',
  'news':                'claude-sonnet-4-20250514',
  'jobs':                'claude-sonnet-4-20250514',
  'gd':                  'claude-3-5-sonnet-20241022',  // gd-analysis, gd-score use 3-5
  'coach':               'claude-sonnet-4-20250514',
  'tpo':                 'claude-sonnet-4-20250514',
...
export function estimateHistoricalCostINR(totalTokens, featureKey) {
  const modelSlug = FEATURE_DEFAULT_MODEL[featureKey] || 'claude-sonnet-4-20250514';
  const pricing = MODEL_PRICING[modelSlug] || MODEL_PRICING['claude-sonnet-4-20250514'];
