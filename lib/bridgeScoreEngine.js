...
export const BRIDGE_SCORE_VERSION = "1.0.0";
...
export function calculateCognitiveScore(aptitudeRecords) {
...
export function calculateCompetenceScore(interviewRecords) {
...
export function calculateCommunicationScore(interviewRecords, gdRecords) {
...
export function calculateIntegrity(interviewRecords) {
  const recent = getRecent(interviewRecords, 3);
  let multiplier = 1.00;
...
export function calculateReliability(totalScoresHistory) {
...
export function calculateLearningVelocity(totalScoresHistory) {
...
export function getDataConfidence(totalRecordsCount) {
  if (totalRecordsCount <= 2) return 'Low';
  if (totalRecordsCount <= 5) return 'Medium';
  return 'High';
}

export function getHiringRecommendation(score, disqualified) {
