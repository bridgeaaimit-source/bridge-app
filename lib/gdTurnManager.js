...
export function selectNextSpeaker({
  ...
  // If directly addressed, they MUST speak next (obey user naming preference)
  if (addressedPersonaId && candidates.includes(addressedPersonaId)) {
    return { speakerId: addressedPersonaId, type: 'ai' };
  }
